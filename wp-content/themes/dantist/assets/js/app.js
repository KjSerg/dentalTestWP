...
/* harmony import */ var _plugins_Slick__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../plugins/Slick */ "./resources/js/plugins/Slick.js");
/* harmony import */ var _plugins_SVGLoader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../plugins/SVGLoader */ "./resources/js/plugins/SVGLoader.js");
/* harmony import */ var _plugins_SVGLoader__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_plugins_SVGLoader__WEBPACK_IMPORTED_MODULE_4__);
  ...
  return _createClass(Application, [{
    ...
    value: function showLoaderOnClick() {
      this.$doc.on('click', 'a.show-load, .header a, .footer a', function (e) {
        var test = $(this).attr('href').includes('#') || $(this).attr('href').includes('tel') || $(this).attr('href').includes('mailto');
    ...
    value: function initComponents() {
      this.$doc.ready(function () {
        ...
        var slick = new _plugins_Slick__WEBPACK_IMPORTED_MODULE_3__["default"]();
      });
    }
  }]);
}();
...
function moveToElement($el) {
  ...
  var $selector = $('body').hasClass('open-custom-modal') ? $(document).find('.modal.active') : $('html, body');
  $selector.animate({
...
var Slick = /*#__PURE__*/function () {
  ...
  return _createClass(Slick, [{
    ...
    value: function reviewsSliderInit() {
      $(document).find('.reviews-list').each(function () {
        var $slider = $(this);
        var slickArgs = {
          slidesToShow: 3,
          slidesToScroll: 1,
...
/* harmony export */   openFancyModal: () => (/* binding */ openFancyModal),
...
function openFancyModal($el) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  if ($el.length === 0) return;
  jquery__WEBPACK_IMPORTED_MODULE_0___default().fancybox.open($el, args);
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdental"] = self["webpackChunkdental"] || [];
